...
這是 **GameAuto** 的核心執行引擎 (Android Player)。為了消除使用者對於「自動化輔助」的安全疑慮，我們決定將此核心組件完全開源。
...
本引擎只是 **「手腳 (Hands & Eyes)」**，您需要 **「大腦 (Brain)」** 才能運作。

1.  前往 **[GameAuto AI Editor](https://game-auto-ai.vercel.app)** 製作您的自動化腳本。
2.  在編輯器中下載 JSON 腳本檔案。
3.  將 JSON 傳輸至手機並使用本 App 載入執行。

[👉 立即開始製作腳本](https://game-auto-ai.vercel.app)
